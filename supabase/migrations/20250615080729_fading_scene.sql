/*
  ...
  1. Create users table (if not exists) that references auth.users
  2. Create chat_messages table with proper foreign keys
  3. Enable RLS and create policies
  4. Add performance indexes

  This migration creates the foundation for the AI chat system.
*/
